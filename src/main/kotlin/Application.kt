...
fun main() {
    ...
    // 📰 Güncel Haberler — RSS'ten çekip Gemini ile en önemli haberleri
    ...
    embeddedServer(Netty, port = port, host = "0.0.0.0") {
        ...
        routing {
            ...
            // 📰 Güncel Haberler — arka planda periyodik olarak güncellenen
            // (RSS + Gemini özet) son haberleri döndürüyor. ?sport=football
            // veya ?sport=basketball — belirtilmezse futbol varsayılan.
            ...
            get("/dailyPlayerBio") {
                ...
                if (bio == null) {
                    ...
                    // çekmeyi deniyoruz. Bulunamazsa fotoğrafsız devam
                    // ediyoruz (frontend zaten placeholder gösteriyor).
                    val fallbackPhoto = DatabaseClient.fetchFootballDailyPlayerPhotoFallback(bio.name)
                    call.respond(if (fallbackPhoto != null) bio.copy(imageUrl = fallbackPhoto) else bio)
                } else {
                    call.respond(bio)
                }
            }
